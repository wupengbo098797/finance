...
Slider.prototype.createUI = function(){
	...
	for(let i=0;i<this.imgs.length;i++){
		htmlstr+='<img src="'+this.imgs[i]+'" style="position:absolute;top:48px;';
	...
	$("#box img").css("width","100%");

	//ul li	
	htmlstr='<ul style="position:absolute;list-style:none;right:700px;bottom:10px;z-index:3;">';
	for(let i=0;i<this.imgs.length;i++){
